package com.webronin_26.online_mart_admin

import androidx.appcompat.widget.AppCompatEditText
import androidx.appcompat.widget.AppCompatTextView
import androidx.databinding.BindingAdapter

@BindingAdapter("app:set_edit_text_string")
fun setEditTextString(editText: AppCompatEditText?, string: String?) {
    if (editText != null && string != "") editText.setText(string.toString())
}
